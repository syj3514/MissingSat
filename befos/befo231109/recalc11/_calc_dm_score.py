...
pklsave(give_scores, f"./08_nh_give_dm_scores_host{BGG['id']:04d}.pickle", overwrite=True)
pklsave(take_scores, f"./08_nh_take_dm_scores_host{BGG['id']:04d}.pickle", overwrite=True)
uri.timer.verbose=1